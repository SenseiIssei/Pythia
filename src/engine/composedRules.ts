...
import type { Composed, IndKind, Operand, Rule } from "../types";
import type { Signal } from "./backtest";

// Pure evaluation of composed (user-built) rules — shared by the backtester and
// the LIVE engine, so a rule you compose runs identically in both. No backtest
// import here (keeps the strategies → composedRules dependency acyclic).
...
/** All rules must pass (AND). Returns a signal in the chosen direction. */
