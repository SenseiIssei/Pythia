...
const simParams: Record<string, SimState> = {
  ...
  "crypto:ADA/USD": { drift: 0.00002, vol: 0.004, base: 0.44 },
  "crypto:DOT/USD": { drift: 0.00001, vol: 0.0038, base: 6.25 },
  "crypto:LINK/USD": { drift: 0.00003, vol: 0.0042, base: 14.0 },
  "crypto:AVAX/USD": { drift: 0.00003, vol: 0.0045, base: 26.7 },
  "crypto:XRP/USD": { drift: 0.00001, vol: 0.0036, base: 0.517 },
  "crypto:LTC/USD": { drift: 0.00001, vol: 0.003, base: 72.4 },
